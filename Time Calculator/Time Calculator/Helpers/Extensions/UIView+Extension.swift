...
extension UIViewController{
    ...
    func showLocationPopup(inVC: UIViewController,ok: @escaping () -> Void,cancel: @escaping () -> Void){
        let alertVC = UIAlertController(title: "Alert", message: "Please enable your location", preferredStyle: .alert)
...
extension String {
    ...
    static let userDateOfBirthFormat : String = "dd-MM-yyyy"
    static let serverDateOfBirthFormat : String = "yyyy-MM-dd"
    static let cardExpiryFormat : String = "MM/yy"
...
extension UIView {
    func dropShadow(scale: Bool = true,height: Int = 1,radius: CGFloat = 4.0,opacity: Float = 0.20) {
